...
# -------------------- Install Modbus nodes and all dependencies --------------------
 && npm install -g --unsafe-perm node-red-contrib-modbus@5.2.0 \
# -------------------- Install Dashboard nodes and all dependencies -----------------
 && npm install -g --unsafe-perm node-red-dashboard@2.19.3 \
# -------------------- Install OPC UA nodes and all dependencies --------------------
 && npm install -g --unsafe-perm node-red-contrib-iiot-opcua@3.12.0 \
# -------------------- Install MSSQL database node and all dependencies --------------------
 && npm install -g --unsafe-perm node-red-contrib-mssql-plus@0.3.2 \
# -------------------- Install PostgresSQL database node and all dependencies --------------------
 && npm install -g --unsafe-perm node-red-contrib-postgres-variable@0.1.4 \
# -------------------- Install SMB file access node and all dependencies --------------------
 && npm install -g --unsafe-perm node-red-contrib-smb@1.1.1 \
